...
(function($) {
	...
	function msg(nombre, email, fono, colegio, mensaje, ID){
 
    var datos = "nombre=" + nombre +"&email=" + email + "&fono=" + fono + "&colegio=" + colegio +"&mensaje=" +mensaje;
				$.ajax({
                data:  datos,
                url:   'msg.php',
                type:  'post',
	...
	function i_rob(nombre, email, fono, colegio, mensaje, grupo){
 
    var datos = "nombre=" + nombre +"&email=" + email + "&fono=" + fono + "&colegio=" + colegio +"&mensaje=" +mensaje +"&grupo=" +grupo;
	// window.alert(datos);
				$.ajax({
                data:  datos,
                url:   'irob.php',
